...
@moduledoc """
Get temperature values using the DHT family of sensors. Please see the 
Sensor.Temp.Dht.Device module's documentation to see how to install the 
necessary drivers for your Raspberry Pi or Pi2.
